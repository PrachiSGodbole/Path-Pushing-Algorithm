...
public class Screen extends Panel implements AdjustmentListener, MouseMotionListener,
	...
	public void paint(Graphics g) {
		...
		// to label the sites
		g.drawString("Site 1", 100, 70);
		g.drawString("Site 2", 300, 70);
		g.drawString("Site 3", 300, 250);
		g.drawString("Site 4", 100, 250);
		
		// to draw the sites
		g.drawRect(70, 70, 103,60);
		g.drawRect(270, 70, 103,60);
		g.drawRect(270, 170, 103,60);
		g.drawRect(70, 170, 103,60);
	}
